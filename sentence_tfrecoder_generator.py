...
cwd = os.getcwd()
CORPUS_PATH = cwd + '/corpus/lip_corpus.txt'
print(CORPUS_PATH)
# ROOT_PATH = '/media/lab/文档/sentence_level_lrs2/main'
# TFRecord_PATH = '/media/lab/文档/sentence_level_lrs2/sentence_lip_data_tfrecord_v3'
# TRAIN_PATH = '/media/lab/文档/sentence_level_lrs2/lr_train.txt'

# ROOT_PATH = '/home/vivalavida/massive_data/lip_reading_data/sentence_level_lrs2/main'
# TFRecord_PATH = '/home/vivalavida/massive_data/lip_reading_raw_main/'
# TRAIN_PATH = '/home/vivalavida/massive_data/lip_reading_data/sentence_level_lrs2/lr_train.txt'
# ROOT_PATH = '/home/wonderwall/data/sentence_level_lrs2/pretrain/'
# TFRecord_PATH = '/home/wonderwall/data/lip_reading_raw_pre_train/'
# TRAIN_PATH = '/home/wonderwall/data/sentence_level_lrs2/lr_pretrain.txt'

ROOT_PATH = '/home/wonderwall/data/word_level_lrw'
TFRecord_PATH = '/home/wonderwall/data/lip_reading_word'
TRAIN_PATH_WORD = '/home/wonderwall/data/word_level_lrw'
# ROOT_PATH = '/home/wonderwall/data/sentence_level_lrs2/pretrain'
# TFRecord_PATH = '/home/wonderwall/data/lip_reading_raw_pre_train/'
# TRAIN_PATH = '/home/wonderwall/data/sentence_level_lrs2/lr_pretrain.txt'
...
# ROOT_PATH = '/home/vivalavida/massive_data/lip_reading_data/sentence_level_lrs2/pretrain'
# TFRecord_PATH = '/home/vivalavida/massive_data/pretrain_sentence_tfrecord'
# TRAIN_PATH = '/home/vivalavida/massive_data/lip_reading_data/sentence_level_lrs2/lr_pretrain.txt'
...
vgg16 = get_vgg()
vgg16_flatten = vgg16.get_layer('activation_21')
...
def tfrecord_generater(record_dir, raw_data, index):
    ...
    raw_data, _, word = data_file_helper.read_file(TRAIN_PATH_WORD)
